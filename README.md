...
> This is an educational project to make a todo-app following this tutorial [React Tutorial From Scratch: A Step-by-Step Guide (2021)](https://ibaslogic.com/react-tutorial-for-beginners/). This tutorial, divided into several parts, is very comprehensive, and covers all main concepts about React, from the very basics to some intermediate topics. This tutorial is not a substitute, just a reinforcement of what you have learned.
...
## Website Mockup 📱 💻 🖥️
![app_screenshot](https://user-images.githubusercontent.com/98527559/171048163-51c6aae2-9359-4c05-b06d-b381feafc3f6.png)
...
Check the live demo [here](https://mavericks-db.github.io/react-todo-app/)👈
...
```
$ git clone git@github.com:mavericks-db/react-todo-app.git
```
...
Feel free to check the [issues page](https://github.com/mavericks-db/react-todo-app/issues).
